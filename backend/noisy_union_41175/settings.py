"""
Django settings for noisy_union_41175 project.
...
ROOT_URLCONF = 'noisy_union_41175.urls'
...
WSGI_APPLICATION = 'noisy_union_41175.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_union_41175 API",
    "DESCRIPTION": "API documentation for noisy_union_41175 App",
    "VERSION": "v1",
}
